...
<center>
<div class="alert">
Hi Survivor. Verify your account to receive your selected prize
<br>
<span id="timer1"></span>
</div>
</center>
...
<input type="text" class="input-anjir"  name="nickname" placeholder="Character Name" autocomplete="off" required>
